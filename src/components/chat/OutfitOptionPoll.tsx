...
import { Layers, List, AlignJustify, ArrowRight } from 'lucide-react';
import type { OutfitGenerationOption } from '../../types';

interface OutfitOptionPollProps {
    options: OutfitGenerationOption[];
    onSelect: (option: OutfitGenerationOption) => void;
    disabled?: boolean;
}

// Icon mapping for different outfit option types based on value
...
const OutfitOptionPoll: React.FC<OutfitOptionPollProps> = ({ options, onSelect, disabled }) => {
                ...
                return (
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between w-full mb-2 relative z-10">
                            ...
                            >
                                {disabled ? (
                                    <IconComponent className="w-3.5 h-3.5 text-text-muted dark:text-stone-500" />
                                ) : (
...
export default OutfitOptionPoll;
