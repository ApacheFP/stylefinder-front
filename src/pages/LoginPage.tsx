    ...
    <div className="min-h-screen flex items-center justify-center bg-background dark:bg-surface-dark px-4 py-8 relative overflow-hidden">
      ...
      <div className="max-w-md w-full bg-cream-100/95 dark:bg-surface-darker/90 backdrop-blur-sm rounded-2xl shadow-lg p-6 md:p-8 border border-cream-300 dark:border-surface-muted relative z-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 md:space-y-5">
          ...
          <button
            type="button"
            onClick={() => window.location.href = 'http://localhost:5000/api/user/login/google'}
            className="w-full flex items-center justify-center gap-2 px-4 py-3 border border-gray-300 dark:border-surface-muted rounded-xl bg-white dark:bg-surface-muted/50 hover:bg-gray-50 dark:hover:bg-surface-muted transition-colors text-text-dark dark:text-white font-medium shadow-sm"
          >
